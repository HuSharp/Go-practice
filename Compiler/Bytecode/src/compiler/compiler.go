...
// WithConstants is the option to create Compiler with a specific constans .
func WithConstants(constants []object.Object) CreateOption {
	return func(compiler *Compiler) {
...
func (c *Compiler) Compile(node ast.Node) error {
	...
	case *ast.FunctionLiteral:
		...
		localNums := c.symbolTable.numDefinitions
		...
		compiledFn := &object.CompiledFunction{Instructions: instructions, LocalNums: localNums, ParameterNums: len(node.Parameters)}
